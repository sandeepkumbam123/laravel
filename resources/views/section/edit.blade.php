...
<section class="content">
    ...
    <br>
    <form method = 'POST' action = '{!! url("portal/section")!!}/{!!$section->
        sectionID!!}/update'>
        ...
        <div class="form-group has-feedback {{ $errors->has('branches_branchID') ? ' has-error' : '' }}">
            ...
            <select id="branches_branchID" name="branches_branchID" class="form-control">
                ...
                @foreach($all_branches  as $branch)
                    <option value="{{ $branch->branchID }}"
                            @if (old('branches_branchID',$section->branches_branchID) == $branch->branchID) selected="selected" @endif>{{ ucfirst($branch->branch_name) }}</option>
            ...
            <?php }else{ ?>
            <input type="hidden" name="branches_branchID" value="{{$section->branches_branchID}}">
            <?php } ?>
        ...
        <div class="form-group has-feedback {{ $errors->has('section_name') ? ' has-error' : '' }}">
            ...
            <input id="section_name" name="section_name" type="section_name" class="form-control" value="{{old('section_name', $section->
            section_name)}}" autocomplete="off">
            <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
        ...
        <input type="hidden" id="old_branch" value="<?php echo old('branches_branchID',$section->branches_branchID); ?>">
        <input type="hidden" id="old_class" value="<?php echo old('class_names_classID',$section->class_names_classID); ?>">
