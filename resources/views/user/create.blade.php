...
@section('content')
    ...
    <section class="content">
        ...
        <br>
        <form method='POST' action='{!!url("portal/user")!!}' enctype="multipart/form-data">
            ...
            <div class="form-group has-feedback {{ $errors->has('reg_number') ? ' has-error' : '' }}">
                ...
                <input id="reg_number" name="reg_number" type="reg_number" class="form-control" value="{{old('reg_number')}}" autocomplete="off">
                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
