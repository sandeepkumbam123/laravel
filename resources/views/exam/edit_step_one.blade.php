...
@section('content')
    ...
    <section class="content">
        ...
        <br>
        <form method='POST' action='{!! url("portal/editexam-stepone")!!}'>
            <input type='hidden' name='_token' value='{{Session::token()}}'>


            <div class="form-group has-feedback {{ $errors->has('title') ? ' has-error' : '' }}">
                <label for="title">Title</label>
                <input id="title" name="title" type="text" class="form-control" value="{{old('title',$exam->title)}}" autocomplete="off">
                ...
                <select id="branches_branchID" name="branches_branchID" class="form-control">
                    ...
                    @foreach($all_branches  as $branch)
                        <option value="{{ $branch->branchID }}"
                                @if (old('branches_branchID',$exam->branches_branchID) == $branch->branchID) selected="selected" @endif>{{ ucfirst($branch->branch_name) }}</option>
            ...
            <div class="form-group has-feedback {{ $errors->has('exam_date') ? ' has-error' : '' }}">
                ...
                <input id="exam_date" name="exam_date" type="date" class="form-control" value="{{old('exam_date',date("Y-m-d",strtotime(str_replace("-","/",$exam->exam_date))))}}" autocomplete="off">
                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
            ...
            <div class="form-group has-feedback {{ $errors->has('exam_manualID') ? ' has-error' : '' }}">
                ...
                <input id="exam_manualID" name="exam_manualID" type="text" class="form-control" value="{{old('exam_manualID', $exam->exam_manualID)}}" autocomplete="off">
                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
            ...
            <div class="form-group has-feedback {{ $errors->has('critical_level') ? ' has-error' : '' }}">
                ...
                <select id="critical_level" name="critical_level" class="form-control">
                    ...
                    @foreach($critical_level  as $key=>$value)
                        <option value="{{ $key }}"
                                @if (old('critical_level',$exam->critical_level) == $key) selected="selected" @endif>{{ ucfirst($value) }}</option>
            ...
            <div class="form-group has-feedback {{ $errors->has('total_marks') ? ' has-error' : '' }}">
                ...
                <input id="total_marks" name="total_marks" type="number" class="form-control" value="{{old('total_marks',$exam->total_marks)}}" autocomplete="off">
                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
            ...
            <div class="form-group has-feedback {{ $errors->has('pass_percentage') ? ' has-error' : '' }}">
                ...
                <input id="pass_percentage" name="pass_percentage" type="number" class="form-control" value="{{old('pass_percentage',$exam->pass_percentage)}}" autocomplete="off">
                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
            ...
            <div class="form-group has-feedback {{ $errors->has('negative_mark') ? ' has-error' : '' }}">
                ...
                <input id="negative_mark" name="negative_mark" type="number" class="form-control" value="{{old('negative_mark',$exam->negative_mark)}}" autocomplete="off">
                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
            ...
            <div class="form-group has-feedback {{ $errors->has('duration') ? ' has-error' : '' }}">
                ...
                <input id="duration" name="duration" type="number" class="form-control" value="{{old('duration',$exam->duration)}}" autocomplete="off">
                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
            ...
            <div class="form-group has-feedback {{ $errors->has('notes') ? ' has-error' : '' }}">
                ...
                <textarea id="notes" name="note" rows="6" class="form-control">{{old('note',$exam->note)}}</textarea>
                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                @if ($errors->has('note'))
                    <span class="help-block">
