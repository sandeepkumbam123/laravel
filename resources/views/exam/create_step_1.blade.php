...
@section('content')
	...
	<section class="content">
		...
		<br>
		<form method='POST' action='{!!url("portal/search-questions")!!}'>
			...
			<div class="form-group has-feedback {{ $errors->has('exam_manualID') ? ' has-error' : '' }}">
				...
				<input id="exam_manualID" name="exam_manualID" type="text" class="form-control" value="{{old('exam_manualID')}}" autocomplete="off">
				<span class="glyphicon form-control-feedback" aria-hidden="true"></span>
