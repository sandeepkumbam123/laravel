<?php $__env->startSection('content'); ?>
    ...
    <section class="content">
        ...
        <br>
        <form method='POST' action='<?php echo url("portal/exam/generate-exam"); ?>' enctype="multipart/form-data">
            <input type='hidden' name='_token' value='<?php echo e(Session::token()); ?>'>

            <div class="form-group has-feedback <?php echo e($errors->has('title') ? ' has-error' : ''); ?>">
                <label for="title">Title</label>
                <input id="title" name="title" type="text" class="form-control" value="<?php echo e(old('title')); ?>" autocomplete="off">
            ...
            <div class="form-group has-feedback <?php echo e($errors->has('exam_date') ? ' has-error' : ''); ?>">
                ...
                <input id="exam_date" name="exam_date" type="date" class="form-control" value="<?php echo e(old('exam_date')); ?>" autocomplete="off">
                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
            ...
            <div class="form-group has-feedback <?php echo e($errors->has('exam_manualID') ? ' has-error' : ''); ?>">
                ...
                <input id="exam_manualID" name="exam_manualID" type="text" class="form-control" value="<?php echo e(old('exam_manualID',$uniqid)); ?>" autocomplete="off">
                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                ...
                <select id="critical_level" name="critical_level" class="form-control">
                    ...
                    <?php $__currentLoopData = $critical_level; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($key); ?>"
                                <?php if(old('critical_level') == $key): ?> selected="selected" <?php endif; ?>><?php echo e(ucfirst($value)); ?></option>
            ...
            <div class="form-group has-feedback <?php echo e($errors->has('total_marks') ? ' has-error' : ''); ?>">
                ...
                <input id="total_marks" name="total_marks" type="number" class="form-control" value="<?php echo e(old('total_marks')); ?>" autocomplete="off">
                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
            ...
            <div class="form-group has-feedback <?php echo e($errors->has('pass_percentage') ? ' has-error' : ''); ?>">
                ...
                <input id="pass_percentage" name="pass_percentage" type="number" class="form-control" value="<?php echo e(old('pass_percentage')); ?>" autocomplete="off">
                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
            ...
            <div class="form-group has-feedback <?php echo e($errors->has('negative_mark') ? ' has-error' : ''); ?>">
                ...
                <input id="negative_mark" name="negative_mark" type="number" class="form-control" value="<?php echo e(old('negative_mark')); ?>" autocomplete="off">
                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
            ...
            <div class="form-group has-feedback <?php echo e($errors->has('duration') ? ' has-error' : ''); ?>">
                ...
                <input id="duration" name="duration" type="number" class="form-control" value="<?php echo e(old('duration')); ?>" autocomplete="off">
                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
            ...
            <div class="form-group has-feedback <?php echo e($errors->has('note') ? ' has-error' : ''); ?>">
                <label for="note">Notes</label>

                <textarea id="note" name="note" rows="6" class="form-control"><?php echo e(old('note')); ?></textarea>
                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
