<?php $__env->startSection('content'); ?>
    ...
    <section class="content">
        ...
        <br>
        <form method='POST' action='<?php echo url("portal/syllabus"); ?>/<?php echo $syllabus->
        syllabuseID; ?>/update'>
            <input type='hidden' name='_token' value='<?php echo e(Session::token()); ?>'>
            <div class="form-group has-feedback <?php echo e($errors->has('syllabus') ? ' has-error' : ''); ?>">
                <label for="syllabus">Syllabus</label>
                <input id="syllabus" name="syllabus" type="syllabus" class="form-control" value="<?php echo e(old('syllabus',$syllabus->
            syllabus)); ?>" autocomplete="off">
