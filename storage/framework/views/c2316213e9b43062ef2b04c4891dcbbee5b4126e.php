...
<head>
    ...
    <link rel="SHORTCUT ICON" href="<?php echo e(asset('images/favico.png')); ?>"/>
    <!-- CSRF Token -->
    <meta name="_token" content="<?php echo e(csrf_token()); ?>">

    <title><?php echo e(config('app.name', 'Quest | Webportal')); ?></title>
    ...
    <link rel="stylesheet" type="text/css" media="all" href="<?php echo e(asset('css/bootstrap.css')); ?>">
    <link rel="stylesheet" type="text/css" media="all" href="<?php echo e(asset('css/bootstrap-datepicker.css')); ?>">
    <!-- Font Awesome -->
    ...
    <link rel="stylesheet" type="text/css" media="all" href="<?php echo e(asset('css/select2.css')); ?>">

    <link rel="stylesheet" type="text/css" media="all" href="<?php echo e(asset('css/style.css')); ?>">
        ...
        <div class="container">
            <div class="row">
                <div class="navbar-header col-xs-12 col-sm-4 col-md-3 col-pad-0">
                    <a class="navbar-brand" href="<?php echo e(url('/secure/dashboard')); ?>">
                        <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Quest" title="Quest" class="img-responsive"/>
                    </a>
                ...
                <div class="col-xs-12 col-sm-8 col-md-9 col-pad-0">
                    ...
                    <?php if((session()->has('user_id'))  ): ?>
                        <ul class="nav navbar-nav navbar-right">
                            <li>
                                <a href="#">Welcome <?php echo e(ucfirst(Session::get('user_name'))); ?></a>
                            </li>
                            <li class="logout">
                                <a href="<?php echo e(url('/secure/logout')); ?>" title="Logout">Logout</a>
                            </li>
                        </ul>
                    <?php endif; ?>
                </div>
        ...
        <aside class="navigation col-xs-12 col-sm-4 col-md-3 col-pad-0 equal-heights" id="primary-nav">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="<?php echo e(URL::to('/portal/branch')); ?>" class="nb-icon-branch <?php echo e(Session::get("menuindex")==2 ? ' active' : ''); ?>">Branches</a></li>
                    <?php } ?>

                    <li><a href="<?php echo e(URL::to('/portal/class')); ?>" class="nb-icon-list <?php echo e(Session::get("menuindex")==2 ? ' active' : ''); ?>">Classes</a></li>
                    <li><a href="<?php echo e(URL::to('/portal/section')); ?>" class="nb-icon-section <?php echo e(Session::get("menuindex")==5 ? ' active' : ''); ?>">Sections</a></li>
                    <li><a href="<?php echo e(URL::to('/portal/subject')); ?>" class="nb-icon-subject <?php echo e(Session::get("menuindex")==3 ? ' active' : ''); ?>">Subjects</a></li>
                    <li><a href="<?php echo e(URL::to('/portal/chapter')); ?>" class="nb-icon-chapter <?php echo e(Session::get("menuindex")==4 ? ' active' : ''); ?>">Chapters</a></li>
                    <li><a href="<?php echo e(URL::to('/portal/question')); ?>" class="nb-icon-question <?php echo e(Session::get("menuindex")==1 ? ' active' : ''); ?>">Questions</a></li>
                    <li><a href="<?php echo e(URL::to('/portal/exam-list')); ?>" class=" nb-icon-exam <?php echo e(Session::get("menuindex")==6 ? ' active' : ''); ?>">Exams</a></li>
                    <li><a href="<?php echo e(URL::to('/portal/user')); ?>" class="nb-icon-users <?php echo e(Session::get("menuindex")==6 ? ' active' : ''); ?>">Students</a></li>
                    <li><a href="<?php echo e(URL::to('/portal/teacher')); ?>" class="nb-icon-teacher <?php echo e(Session::get("menuindex")==6 ? ' active' : ''); ?>">Teachers</a></li>
