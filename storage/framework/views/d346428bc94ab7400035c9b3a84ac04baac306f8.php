<?php $__env->startSection('content'); ?>
	...
	<section class="content">
		...
		<br>
		<form method='POST' action='<?php echo url("portal/search-questions"); ?>'>
			...
			<div class="form-group has-feedback <?php echo e($errors->has('exam_manualID') ? ' has-error' : ''); ?>">
				...
				<input id="exam_manualID" name="exam_manualID" type="text" class="form-control" value="<?php echo e(old('exam_manualID')); ?>" autocomplete="off">
				<span class="glyphicon form-control-feedback" aria-hidden="true"></span>
