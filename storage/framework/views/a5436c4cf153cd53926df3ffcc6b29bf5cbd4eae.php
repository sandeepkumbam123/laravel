<?php $__env->startSection('content'); ?>
    <section class="content">
        ...
        <br>
        <form method='POST' action='<?php echo url("portal/user"); ?>/<?php echo $user->
        userID; ?>/update' enctype="multipart/form-data">
            ...
            <div class="form-group has-feedback <?php echo e($errors->has('reg_number') ? ' has-error' : ''); ?>">
                <label for="reg_number">Register Number</label>
                <input id="reg_number" name="reg_number" type="reg_number" class="form-control" value="<?php echo e(old('reg_number',$user->reg_number)); ?>" autocomplete="off">
                <input type="hidden" name="old_reg_number" value="<?php echo e($user->reg_number); ?>">
                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                <?php if($errors->has('reg_number')): ?>
                    <span class="help-block">
                        <strong><?php echo e($errors->first('reg_number')); ?></strong>
                    </span>
                <?php endif; ?>
            </div>
