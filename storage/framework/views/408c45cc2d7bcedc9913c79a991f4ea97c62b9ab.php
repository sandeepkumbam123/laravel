<?php $__env->startSection('content'); ?>
	<section class="content">
		...
		<form method='get' action='<?php echo url("portal/editexam-stepone/10/edit"); ?>'>
			<button class='btn btn-danger'>Go Back</button>
		</form>
		<br>
		<form onsubmit="return validate_question()" method='POST' action='<?php echo url("portal/update-exam"); ?>' class="form-inline">
			...
			<table class="table table-striped" id="example">
				...
				<?php $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<tr>
						<td><input  class="question_check" type="checkbox" data-ques_mark="<?php echo e($question->mark); ?>" name="selected_questions[]"  <?php if(in_array($question->questionID,$old_questions)){echo "checked";}?>  value="<?php echo $question->questionID; ?>"></td>
                        <td><?php
            ...
            <input type="hidden" name="examID" value="<?php echo $input_data["examID"] ?>">
		</form>
	</section>
